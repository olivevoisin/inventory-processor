...
jest.mock('../../modules/translation-service', () => ({
  ...
  batchTranslate: jest.fn().mockImplementation((texts, source, target) => {
...
describe('I18n Routes', () => {
  beforeEach(() => {
    jest.clearAllMocks();
    // Mock detectLanguage to return 'ja' for Japanese text
    require('../../modules/translation-service').detectLanguage.mockImplementation((text) => {
      if (text === 'こんにちは世界') return Promise.resolve('ja');
