 ...
 */
// Correct the import path assuming invoice-processor-deps.js is in <rootDir>/__mocks__/
const { mockFs, mockPdfParse, mockTesseract, mockOcrService, mockTranslationService, mockLogger } = require('../../../__mocks__/invoice-processor-deps');

// Setup mocks before requiring the module
jest.mock('fs', () => mockFs);
jest.mock('../../../modules/ocr-service', () => mockOcrService); // Corrected path
jest.mock('../../../modules/translation-service', () => mockTranslationService); // Corrected path
// Correct the logger mock usage
jest.mock('../../../utils/logger', () => mockLogger); // Corrected path
