...
describe('Translation Service - Function Coverage Tests', () => {
  ...
  describe('detection and error handling', () => {
    it('should detect French with multiple accented characters', () => {
      const result = translationService.detectLanguage('voilà où se trouve le café');
      expect(result).toBe('fr');
    });
    
    it('should detect Japanese with multiple character types', () => {
      const result = translationService.detectLanguage('こんにちは世界！ありがとう。');
